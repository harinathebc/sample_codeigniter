              ...
              <div class="col-md-12">
				...
				<form name ="userinput" action="<?php echo site_url('group/update'); ?>" method="POST">
					<div class="col-md-6 col-sm-6 alert-info">
                        ...
                        <h4>Account/Group </h4>
						<div class="col-md-12">
							OrganizationID<input type="text" name="organizationid" id="organizationid" value="<?php echo htmlentities($groupdata['organization_id']);?>" readonly="readonly"  required="required"/>
						</div>
						<div class="col-md-12">
						...
						<div class="col-md-12">
							Account number<input type="text" name="accountnumber" id="accountnumber" value="<?php echo htmlentities($groupdata['account_number']);?>" readonly="readonly"  required="required"/>
						</div>
						<div class="col-md-12">
