<div class="page">
 ...
 ///echo $net_internal.'---'.$net_external; exit; ?>
	...
	<?php $total_vul = ($total_vul_ipscount_external+$total_vul_ipscount_internal+$total_vul_empcount_external+$total_vul_empcount_internal)/$devidend_vul;
...
<?php $userdeetails = $this->session->userdata('userdetails');?>
	...
	<div class="text-xs-right">
            <a href="<?php echo base_url('user/pdf/'.base64_encode($quote_id));?>/service" class="btn btn-animate btn-animate-side btn-primary" target="_blank">
              <span><i class="icon wb-print" aria-hidden="true"></i> Estimation + Summary</span>
            </a>
            <a href="<?php echo base_url('user/pdf/'.base64_encode($quote_id));?>" class="btn btn-animate btn-animate-side btn-info" target="_blank">
