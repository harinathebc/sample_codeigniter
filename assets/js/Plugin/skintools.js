...
(function(window, document) {
  ...
  var settings = localStorage.getItem('MyBenefitslab.topmenu.skinTools');
    ...
    (function(window, document, $) {
      ...
      var Skintools = {
        tpl: '<div class="site-skintools">' +
          ...
          '<li role="presentation" class="nav-item"><a class="nav-link" role="tab" aria-controls="skintoolsNavbar" href="#skintoolsNavbar" data-toggle="tab" aria-expanded="false">Navbar</a></li>' +
          '<li role="presentation" class="nav-item"><a class="nav-link" role="tab" aria-controls="skintoolsPrimary" href="#skintoolsPrimary" data-toggle="tab" aria-expanded="false">Primary</a></li>' +
          '</ul>' +
          ...
          '<button class="btn btn-outline btn-block btn-primary m-t-20" id="skintoolsReset" type="button">Reset</button>' +
          '</div>' +
          '</div>' +
          '</div>' +
          '</div>' +
        ...
        storageKey: 'MyBenefitslab.topmenu.skinTools',
        defaultSettings: {
          'sidebar': 'light',
          'navbar': 'primary',
          'navbarInverse': 'true',
